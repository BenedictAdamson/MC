 ...
 */
@Entity
public final class NewUserSpecification implements UserDetails {
   ...
   /**
    * <p>
    * Create a {@link NewUserSpecification} that is a valid administrator user.
    * </p>
    * <ul>
    * <li>Returns a (non null) {@link NewUserSpecification}.</li>
    ...
    */
   @Nonnull
   public static NewUserSpecification createAdministrator(@Nullable final String password) {
      return new NewUserSpecification(password);
   }
   ...
   private NewUserSpecification(final String password) {
   ...
   public NewUserSpecification(@NonNull @JsonProperty("id") final UUID id,
    ...
    * </p>
    * <ul>
    * <li>The {@link NewUserSpecification} class has <i>entity semantics</i>, with the
    ...
    * {@link NewUserSpecification} and the two have {@linkplain String#equals(Object)
   ...
   public boolean equals(final Object that) {
      ...
      if (!(that instanceof NewUserSpecification)) {
         return false;
      }
      final var other = (NewUserSpecification) that;
